...
class TestClient(unittest.TestCase):
    ...
    @patch("sequoia.registry.Registry")
    @patch("requests_oauthlib.OAuth2Session")
    def test_create_client_with_correlation_id(self, mock_oauth2_session, mock_registry, mock_http_executor):
        mock_http_executor.return_value = mock_http_executor
        client = Client('http://mock-registry/services/testmock',
                        grant_client_id='piksel-workflow',
                        grant_client_secret='blablabla',
    ...
    @patch("sequoia.registry.Registry")
    @patch("requests_oauthlib.OAuth2Session")
    def test_create_client_generate_correlation_id(self, mock_oauth2_session, mock_registry, mock_http_executor):
        mock_http_executor.return_value = mock_http_executor
        client = Client('http://mock-registry/services/testmock',
                        grant_client_id='piksel-workflow',
                        grant_client_secret='blablabla',
    ...
    @patch("sequoia.registry.Registry")
    @patch("requests_oauthlib.OAuth2Session")
    def test_create_client_generate_correlation_id_with_autogenerated_transaction_id(self, mock_oauth2_session,
    ...
    @patch("sequoia.registry.Registry")
    @patch("requests_oauthlib.OAuth2Session")
    def test_create_client_should_prioritizise_correlation_id_over_arguments_to_build_it(self, mock_oauth2_session,
                                                                                         mock_registry,
                                                                                         mock_http_executor):
        mock_http_executor.return_value = mock_http_executor
        client = Client('http://mock-registry/services/testmock',
